...
\_   ___ \           /   _____//  |________  ____   _____  
/    \  \/   ______  \_____  \\   __\_  __ \/  _ \ /     \ 
\     \____ /_____/  /        \|  |  |  | \(  <_> )  Y Y  \
 \______  /         /_______  /|__|  |__|   \____/|__|_|  /
        \/                  \/                          \/ 
                                         """
    if ASCII_MODE:
        logo = ""
...
def do_zip_update():
    ...
    if success:
        mesgdcrt.SuccessMessage("C-Strom was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update C-Strom.")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/hackops-academy/C-Strom")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/hackops-academy/C-Strom HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("C-Strom is up-to-date")
        mesgdcrt.GeneralMessage("Starting C-Strom")


def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/hackops-academy/C-Strom/raw/dev/.notify"
        else:
            url = "https://github.com/hackops-academy/C-Strom/raw/master/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("C-Strom was created by Hackops-Academy")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("C-Strom will work only in Python v3")
    sys.exit()
...
__CONTRIBUTORS__ = ['Hackops-Academy']
...
description = """C-Strom - Your Friendly Spammer Application

C-Strom can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

C-Strom is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by Hackops-Academy !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start C-Strom with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start C-Strom with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start C-Strom with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update C-Strom")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current C-Strom contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current C-Strom version")
